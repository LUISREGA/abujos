...
{
"optionName": "SALAM BROTHER BY REXA"
}
],
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`NANZ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`NANZ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${iphone}` }, { quoted: doc })
}
}
break
case 'rexavirtext2': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${iphone1}` }, { quoted: doc })
}
}
break
case 'rexavirtext3': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${iphone2}` }, { quoted: doc })
}
}
break
case 'rexavirtext4': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${iphone3}` }, { quoted: doc })
}
}
break
case 'rexavirtext5': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${iphone4}` }, { quoted: doc })
}
}
break
case 'rexavirtext6': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${iphone5}` }, { quoted: doc })
}
}
break
case 'rexavirtext7': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${iphone6}` }, { quoted: doc })
}
}
break
case 'rexavirtext8': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${buttonkal}` }, { quoted: doc })
}
}
break
case 'rexavirtext9': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${buttonvirus}` }, { quoted: doc })
}
}
break
case 'rexavirtext10': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `NANZ ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
...
"contactMessage": {
"displayName": `©NANZ${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `©NANZ${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `©NANZ${ngazap(prefix)}`,
...
"retailerId": `©NANZ WE ARE NOT MASTOD`,
...
Base Script
©rexa
۝REXA BOTZ۝`, contextInfo:{"externalAdReply": {"title": `SCnoxa`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
╠➤afk { 𝐤𝐚𝐬𝐢𝐡 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧𝐬 }
╠➤rexaghoib [ 𝐨𝐧 / 𝐨𝐟𝐟 ]
╠➤rexajagoan [ 𝐫𝐞𝐩𝐥𝐲 𝐭𝐚𝐫𝐠𝐞𝐭 ]
╠➤rexasange [ 𝐇𝐚𝐫𝐮𝐬 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 𝐀𝐝𝐦𝐢𝐧 ]
╠➤bugtiktok [ 𝐋𝐢𝐧𝐤 ] - 𝐁𝐮𝐠 𝐒𝐰
╠➤jadikatalog [ 𝐫𝐞𝐩𝐥𝐲 𝐬𝐭𝐢𝐜𝐤𝐞𝐫 ] 𝐣𝐮𝐦𝐥𝐚𝐡
╚════[ REXA ]══════⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬

╔══════[ 𝐁𝐔𝐆 𝐓𝐀𝐑𝐆𝐄𝐓 ]══════⊱
╠➤rexaskuy 𝟔𝟐𝟖𝐱𝐱𝐱
╠➤rexasantet 𝟔𝟐𝟖𝐱𝐱𝐱@𝐬.𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.𝐧𝐞𝐭|𝟏𝟎|𝟏𝟎𝐬
╠➤catalogpc 𝟔𝟐𝟖𝐱𝐱𝐱@𝐬.𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.𝐧𝐞𝐭|𝟏𝟎|𝟏𝟎𝐬
╚════[ REXA ]══════⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬

𝐊𝐞𝐭𝐢𝐤 > 𝐦.𝐜𝐡𝐚𝐭 ( 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩 𝐝𝐮𝐥𝐮🌷)
╔══════[ 𝐁𝐔𝐆 𝐆𝐑𝐎𝐔𝐏 ]══════⊱
╠➤rexagas 𝟏𝟏𝟐𝟔𝟕𝟒𝟒𝟒𝟖𝐱𝐱𝐱
╠➤santetgc  𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱@𝐠.𝐮𝐬|𝟏𝟎|𝟏𝟎𝐬
╠➤catalogpc 𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱@𝐠.𝐮𝐬|𝟏𝟎|𝟏𝟎𝐬
╚════[ REXA ]══════⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `©REXA WE ARE NOT MASTOD`,
"url": "Wa.me/6285714170944"
},
"businessOwnerJid": "6285714170944@s.whatsapp.net",
}
